              ...
              >
                ...
                >
                  ...
                  <div className="relative aspect-[4/5] overflow-hidden flex-shrink-0 rounded-t-2xl">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/25 to-transparent group-hover:from-black/75 group-hover:via-black/40 transition-all duration-300" />
